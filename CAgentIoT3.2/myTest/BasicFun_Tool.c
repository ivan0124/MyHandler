...
//		return strlen(lpReturnedString);
	...
	while ( !feof(file) )	//�ˬd�ɮ׫��ЬO�_���F����
	{
		...
		{
			strcpy( lpReturnedString, lpDefault );	// �S���������Ʈɦ^�� default ��
			fclose(file);
			return strlen(lpReturnedString);
		}
...
int	SplitUrl(char *url, char *ip, int *port, char* path )
{
	...
	toLOWER( url, 4 );
	//��http://�A�s�Wrtsp�P�_�Akidd 2010/10/20
