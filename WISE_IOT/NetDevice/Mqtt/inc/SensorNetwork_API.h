...
//  Callback Function 
//-----------------------------------------------------------------------------
typedef SN_CODE  (SNCALL *UpdateSNDataCbf) ( const int cmdId, const void *pInData, const int InDatalen, void *pUserData, void *pOutParam, void *pRev1, void *pRev2 ); 
...
void SNCALL SN_SetUpdateDataCbf(UpdateSNDataCbf pUpdateSNDataCbf);
...
typedef SN_CODE(SNCALL *SN_Initialize_API)					(void *pInUserData);
typedef SN_CODE(SNCALL *SN_Uninitialize_API)				(void *pInParam);
typedef SN_CODE(SNCALL *SN_GetVersion_API)              (char *psVersion, int BufLen);
typedef SN_CODE(SNCALL *SN_SetUpdateDataCbf_API)	(UpdateSNDataCbf pUpdateDataCbf);
typedef SN_CODE(SNCALL *SN_ActionProc_API)				(const int cmdId, void *pParam1, void *pParam2, void *pRev1, void *pRev2);
typedef SN_CODE(SNCALL *SN_GetCapability_API)			(SNInfInfos *pOutSNInfInfo);
typedef SN_CODE(SNCALL *SN_GetData_API)					(SN_CTL_ID CmdID, InSenData *pInSenData, OutSenData *pOutSenData);
typedef SN_CODE(SNCALL *SN_SetData_API)					(SN_CTL_ID CmdID, InSenData *pInSenData, OutSenData *pOutSenData);
