...
typedef SN_CODE  (SNCALL *ReportSNManagerDataCbf) ( const int cmdId, const char *pInJson, const int InDatalen, void **pOutParam, void *pRev1, void *pRev2 ); 
...
SN_CODE SNCALL SN_Manager_Start(void);

SN_CODE SNCALL SN_Manager_Stop(void);

SN_CODE SNCALL SN_Manager_ActionProc(const int cmdId, ReportSNManagerDataCbf pParam1, void *pParam2, void *pRev1, void *pRev2);

//SN_CODE SNCALL SN_Manager_GetCapability(char **ppzOutDataBuffer, int *pnLen );
...
EXPORT int SNCALL GetSNManagerAPILibFn(const char *LibPath, void **pFunInfo);

typedef SN_CODE (SNCALL *SN_Manager_Initialize_API)           ( void );
typedef SN_CODE (SNCALL *SN_Manager_Uninitialize_API)      ( void );
typedef SN_CODE (SNCALL *SN_Manager_GetVersion_API)      ( char *psVersion, int BufLen );
typedef SN_CODE (SNCALL *SN_Manager_ActionProc_API)       ( const int cmdId, ReportSNManagerDataCbf pParam1, void *pParam2, void *pRev1, void *pRev2 );
//typedef SN_CODE (*SN_Manager_GetCapability_API)  (char **ppzOutDataBuffer, int *pnLen);
typedef char* (SNCALL *SN_Manager_GetCapability_API)           ( );
typedef char* (SNCALL *SN_Manager_GetData_API)					 ( const char *pszInUriPath /*URI of Resource*/, const ACTION_MODE mode /* Cache or Direct */);
typedef char* (SNCALL *SN_Manager_SetData_API)					     ( const char *pszInUriPath /*URI of Resource*/,  const char *pszInValue, const void *pUserData );
...
typedef struct SNMANAGERAPI_INTERFACE
{
	...
	SN_Manager_GetVersion_API       SN_Manager_GetVersion;              
