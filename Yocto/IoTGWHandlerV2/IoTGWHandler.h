...
typedef enum{
	UNKNOW_CMD										= 0,
        IOTGW_CONNECT_STATUS   = 1,
        IOTGW_OS_INFO   = 116,
        IOTGW_RECONNECT = 125,
        IOTGW_QUERY_HEART_BEAT_VALUE_REQUEST = 127,
        IOTGW_QUERY_HEART_BEAT_VALUE_REPLY = 128,
        IOTGW_CHANGE_HEART_BEAT_VALUE_REQUEST = 129,
        IOTGW_CHANGE_HEART_BEAT_VALUE_REPLY = 130,
